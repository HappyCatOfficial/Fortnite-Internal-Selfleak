...
static inline float  ImInvLength(const ImVec2& lhs, float fail_value) { float d = lhs.x*lhs.x + lhs.y*lhs.y; if (d > 0.0f) return 1.0f / SpoofRuntime_fixed_sqrtf_A(d); return fail_value; }
...
struct IMGUI_API ImGuiTextEditState
{
	...
	ImGuiTextEditState() { ImGui::memset_(this, 0, sizeof(*this)); }
...
struct ImGuiContext
{
	...
	ImGuiContext() : OverlayDrawList(NULL)
	{
		...
		OverlayDrawList._OwnerName = nullptr; // Give it a name for debugging
		MouseCursor = ImGuiMouseCursor_Arrow;
		//safe_call(memset)(MouseCursorData, 0, sizeof(MouseCursorData));
		...
		//safe_call(memset)(DragDropPayloadBufLocal, 0, sizeof(DragDropPayloadBufLocal));
		...
		//safe_call(memset)(FramerateSecPerFrame, 0, sizeof(FramerateSecPerFrame));
		FramerateSecPerFrameIdx = 0;
		FramerateSecPerFrameAccum = 0.0f;
		WantCaptureMouseNextFrame = WantCaptureKeyboardNextFrame = WantTextInputNextFrame = -1;
		//safe_call(memset)(TempBuffer, 0, sizeof(TempBuffer));
	}
};
...
struct IMGUI_API ImGuiDrawContext
{
	...
	ImGuiDrawContext()
	{
		...
		TextWrapPos = -1.0f;
		//safe_call(memset)(StackSizesBackup, 0, sizeof(StackSizesBackup));
